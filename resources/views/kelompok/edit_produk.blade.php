...
<div class="max-w-3xl mx-auto">
    ...
    <!-- HEADER -->
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-[#1A3636]">Edit Produk</h2>
        <p class="text-sm text-gray-500">Perbarui data produk kelompok binaan</p>
    </div>

    <!-- FORM -->
    <div class="bg-white rounded-2xl shadow p-6">
       <form action="{{ route('kelompok.produk.update', $produk->usaha_id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                @if($produk->gambar_produk)
                    <div class="mb-3">
                        ...
                        <img src="{{ asset('storage/' . $produk->gambar_produk) }}" class="w-32 h-32 object-cover rounded-lg border">
                    </div>
                @endif
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama_usaha" value="{{ old('nama_usaha', $produk->nama_usaha) }}"
            ...
            <div class="mb-4">
                ...
                <select name="komoditas_id" required
                    ...
                    @foreach($komoditas as $item)
                        <option value="{{ $item->komoditas_id }}" {{ old('komoditas_id', $produk->komoditas_id) == $item->komoditas_id ? 'selected' : '' }}>
